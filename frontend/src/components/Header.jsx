          ...
          <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white rounded p-4 border-l-4 border-green-500">
                    ...
                    <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                      ...
                      <li>Registra salones con código (ej: E10, A101)</li>
                  ...
                  <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700">
                    ...
                    <li>Llena:
                      <ul className="list-disc list-inside ml-6 mt-1">
                        ...
                        <li><strong>Salón:</strong> Selecciona uno disponible</li>
              ...
              <div className="border-2 border-pink-200 rounded-lg p-5 bg-pink-50">
                <h3 className="text-2xl font-bold text-pink-900 mb-3">📚 PASO 6: Gestión de Libros</h3>
                
                <div className="space-y-4">
                  <div className="bg-white rounded p-4 border-l-4 border-pink-500">
                    <h4 className="font-bold text-pink-900 mb-2">6.1 Administrar Catálogo de Libros</h4>
                    <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                      <li>Ve a <strong>"Libros"</strong></li>
                      <li>Clic en <strong>"Nuevo Libro"</strong></li>
                      <li>Llena: Título, nivel (A1-C2), precio, stock inicial</li>
                      <li>Agrega descripción y editorial (opcional)</li>
                      <li>El sistema lleva control automático de inventario</li>
                    </ol>
                  </div>
                  ...
                  <div className="bg-white rounded p-4 border-l-4 border-pink-500">
                    ...
                    <div className="mt-2 bg-yellow-50 border border-yellow-200 rounded p-2">
                      <p className="text-xs text-yellow-800">
                        <strong>💡 TIP:</strong> El sistema no permite vender más libros de los que hay en stock.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded p-4 border-l-4 border-pink-500">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
                      <li>En <strong>"Libros"</strong> verás el historial de todas las ventas</li>
                  ...
                  <div className="bg-white rounded p-4 border-l-4 border-teal-500">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
                      ...
                      <li><strong>Reportes Operativos:</strong>
                        <ul className="list-disc list-inside ml-6">
                          <li>Ocupación de salones por horario</li>
              ...
              <div className="border-2 border-gray-300 rounded-lg p-5 bg-gray-50">
                ...
                <div className="space-y-3">
                  <div className="bg-white rounded p-3 border-l-4 border-gray-400">
                    ...
                    <p className="text-xs text-gray-600">✅ Verifica que hayas creado el período, salones y maestros primero</p>
                  </div>
                  ...
                  <div className="bg-white rounded p-3 border-l-4 border-gray-400">
                    <h4 className="font-bold text-gray-800 text-sm mb-1">❓ El salón dice "No disponible"</h4>
                    <p className="text-xs text-gray-600">✅ Ya hay otro grupo usando ese salón en ese horario. Elige otro salón u horario</p>
                  </div>
