  ...
  const loadData = async () => {
    try {
      ...
      if (estatusFilter === 'completado') {
        ...
        // Solo traer los que tienen prórroga
      ...
      // Calcular total de prórrogas (vencidas + por vencer + activas)
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-500 mt-2">
                ℹ️ {stats.prorrogasActivas || 0} prórrogas vigentes (tienen tiempo)
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="flex items-center gap-2 text-sm font-medium mb-1">
                      ...
                      <TooltipIcon text="Número de línea de captura del formato universal" />
                    </label>
                    <input
                      type="text"
                      className="input text-sm"
                ...
                <div className="flex items-center space-x-2 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                  ...
                  <label htmlFor="tiene_prorroga" className="text-sm font-medium flex items-center gap-2">
                    Registrar como pago pendiente con prórroga
                    <TooltipIcon text="Marca esto si el alumno aún NO ha pagado y le das plazo. Si ya pagó, deja esto desmarcado." />
                  </label>
                </div>
